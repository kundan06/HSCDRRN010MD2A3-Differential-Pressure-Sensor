...
#define PRESSURE_MIN -19.29        // min is 0 for sensors that give absolute values
#define PRESSURE_MAX 19.29   // mbar (and we want results in pascals)
...
void setup()
{
             // my particular board needs this
    Serial.begin(9600);
    Wire.begin();
}
